...
public class EmailService {
    ...
    private Email fromInvoicesToEmail(List<invoice> invoices) {
        ...
        String content = this.pasteEmailContent(invoices, personalDetails);
