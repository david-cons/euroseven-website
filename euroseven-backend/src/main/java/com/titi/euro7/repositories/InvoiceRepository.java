...
public interface InvoiceRepository extends JpaRepository<Invoice, Long> {
    ...
    @Query("SELECT new com.titi.euro7.entities.Invoice(i.id, i.created_date, i.due_date, i.price, i.file, i.paid, i.location, i.nrFactura, i.codClient, i.restDePlata, i.indexVechi, i.indexNou) FROM Invoice i WHERE i.codClient = ?1 AND i.paid = false")
    List<Invoice> findAllUnpaidInvoicesByCodClient(Integer codClient);

    @Query("SELECT new com.titi.euro7.entities.Invoice(i.id, i.created_date, i.due_date, i.price, i.file, i.paid, i.location, i.nrFactura, i.codClient, i.restDePlata, i.indexVechi, i.indexNou) FROM Invoice i WHERE i.codClient = ?1")
